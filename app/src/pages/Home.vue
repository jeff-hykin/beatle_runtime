<template>
    <row class=wrapper align-h=left align-v=top>
        ...
        <column class=main-area>
            ...
            <br /><br /> 3. Go to http://{{$root.localIpAddress}}:8080 in the web browser of the other device. You probably want to bookmark that page, or add it to your homescreen for easy access.
        </column>
    </row>
</template>
<script>
